...
// 测试命令 gcc ./utility/secp256k1.c hmac_sha256.c ascon_aead.c aes.c serial.c puf_util.c janus_util.c janus_remote_attestation.c test_main.c -o ./main && sudo ./main
