...
#define SAU_REGION_2_BASE 0x1004FE00U
#define SAU_REGION_2_END 0x1004FFFFU
...
- description: ''
- ahb:
  - regions: [{memory: PROGRAM_FLASH, security: s_priv, start: '0x00000000', size: '0x00050000'}, {memory: PROGRAM_FLASH, security: ns_user, start: '0x00050000',
      size: '0x00050000'}, {memory: BootROM, security: s_priv, start: '0x00000000', size: '0x00020000'}, {memory: SRAMX, security: ns_user, start: '0x00000000', size: '0x00008000'},
    {memory: SRAM0, security: s_priv, start: '0x00000000', size: '0x00010000'}, {memory: SRAM1, security: ns_user, start: '0x00000000', size: '0x00010000'}, {memory: SRAM2,
      security: ns_user, start: '0x00000000', size: '0x00010000'}, {memory: SRAM3, security: ns_user, start: '0x00000000', size: '0x00010000'}, {memory: SRAM4, security: ns_user,
      start: '0x00000000', size: '0x00004000'}, {memory: USB_RAM, security: ns_user, start: '0x00000000', size: '0x00004000'}]
  ...
  - interrupts:
    ...
    - security: {Non-secure: {id: [acmp_capt_irq, adc_irq, casper_irq, ctimer0_irq, ctimer1_irq, ctimer2_irq, ctimer3_irq, ctimer4_irq, flexcomm0_irq, flexcomm1_irq,
          flexcomm2_irq, flexcomm3_irq, flexcomm4_irq, flexcomm5_irq, flexcomm6_irq, flexcomm7_irq, global_irq0, global_irq1, lspi_hs_irq, mailbox_irq, mrt_irq, os_event_irq,
          pin_int4, pin_int5, pin_int6, pin_int7, pin_irq0, pin_irq1, pin_irq2, pin_irq3, plu_irq, pq_irq, qddkey_irq, rtc_irq, sct_irq, sdio_irq, sdma0_irq, sdma1_irq,
          sec_hypervisor_call_irq, sec_int0, sec_int1, sec_vio_irq, sha_irq, sys_irq, usb0_irq, usb0_needclk_irq, usb1_irq, usb1_needclk_irq, usb1_utmi_irq, utick_irq]}}
  - pins_masks:
...
- sau:
  ...
  - regions: [{index: '0', enabled: 'true', security: ns, start: '0x00000000', size: '0x10000000'}, {index: '1', enabled: 'true', security: ns, start: '0x20000000',
      size: '0xD0000000'}, {index: '2', enabled: 'true', security: nsc, start: '0x1004FE00', size: '0x00000200'}, {index: '3', enabled: 'false', security: ns, start: '0x00000000',
...
- user_memory_regions: [{id: Region_1, security: s_priv, name: Secure Code, start: '0x10000000', size: '0x0004FE00'}, {id: Region_2, security: nsc_priv, name: Veneer
      Table, start: '0x1004FE00', size: '0x00000200'}, {id: Region_3, security: s_priv, name: Secure Stack and Data, start: '0x30000000', size: '0x00010000'}, {id: Region_4,
    security: ns_user, name: Non-secure Code, description: Privilege check is disabled so reset value (NS-User) can be used, start: '0x00050000', size: '0x00050000'},
  {id: Region_5, security: ns_user, name: Non-secure Stack and Data, description: 'Privilege check is disabled so reset value (NS-User) can be used. ', start: '0x20010000',
    size: '0x00034000'}]
- mpus:
  - mpu:
    - enabled: 'false'
...
void BOARD_InitTrustZone()
{
    ...
    */
    ...
    AHB_SECURE_CTRL->SEC_CTRL_FLASH_ROM[0].SEC_CTRL_FLASH_MEM_RULE[1] = 0x00000033U;
