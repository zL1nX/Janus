...
class RegistrationTransactionHandler(TransactionHandler):
    '''
...
def handleDevicesSubmission(context, payload):
    ...
    LOGGER.info('Devices are saved at address: %s',
                address)
    state_data = l.SerializeToString()
...
def main():
    ...
    try:
        ...
        handler = RegistrationTransactionHandler(sw_namespace)
